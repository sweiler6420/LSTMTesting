...
neural_network.add_layer(layer_type='lstm', neurons=50, return_sequence=True, input_shape=True, dropout=0)
#neural_network.add_layer(layer_type='lstm', neurons=50, return_sequence=True, input_shape=True, dropout=0)
#neural_network.add_layer(layer_type='lstm', neurons=50, return_sequence=True, input_shape=True, dropout=0)
...
neural_network.train_model(batch_size=1, epochs=10, verbose=1)
